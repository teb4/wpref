...
final class WP_Customize_Widgets {
	...
	public function register_settings() {
		...
		if ( $this->manager->doing_ajax( 'update-widget' ) && Request::isSetWidgetId() ) {
			$widget_setting_ids[] = $this->get_setting_id( wp_unslash( Request::getWidgetId() ) );
		}
		...
		if ( ! empty( $_POST['sanitized_widget_setting'] ) ) {
			...
			if ( ! is_null( $parsed_id['number'] ) ) {
				...
				$_POST[$key] = wp_slash( $value );
                                Request::setKey( $key, wp_slash( $value ) );
